...
namespace NexusStrap
{
    public class Bootstrapper
    {
        ...
        public string MutexName { get; set; } = "NexusStrap-Bootstrapper";
        ...
        public async Task Run()
        {
            ...
            if (!_noConnection)
            {
                ...
                {
                    bool backgroundUpdaterMutexOpen = Utilities.DoesMutexExist("NexusStrap-BackgroundUpdater");
    ...
    version = App.Version;
            ...
            SetStatus(Strings.Bootstrapper_Status_UpgradingNexusStrap);

            try
            {
#if DEBUG_UPDATER
        string downloadLocation = Path.Combine(Paths.TempUpdates, "NexusStrap.exe");
        ...
        private static void StartBackgroundUpdater()
        {
            ...
            if (Utilities.DoesMutexExist("NexusStrap-BackgroundUpdater"))
            {
