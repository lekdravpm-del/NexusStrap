...
namespace NexusStrap.UI.ViewModels.AccountManagers
{
    ...
    public partial class GamesViewModel : ObservableObject
    {
        ...
        private async Task LoadRegionsAsync()
        {
            ...
            {
                App.Logger.WriteLine(LOG_IDENT_REGIONS, "Failed to load datacenters.");
                return;
            }

            App.Logger.WriteLine(LOG_IDENT_REGIONS, "Successfully loaded datacenters");
        ...
        private async Task FindAndJoinServer(long placeId, AltAccount account)
        {
            ...
            try
            {
                ...
                var (regions, _) = datacentersResult.Value;
